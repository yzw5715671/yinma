...
(function($) {
	...
	$.fn.Spinner = function (opts) {
		...
		var defaults = {value:1000, min:1000, len:5, max:99000}
		...
		return this.each(function() {
			...
			a.click(function(){cv(-1000)});
			b.keyup(function(){cv(0)});
			c.click(function(){cv(+1000)});
			b.bind('keyup paste change',function(e){
				e.keyCode==keyCodes.up&&cv(+1000);
				e.keyCode==keyCodes.down&&cv(-1000);
			});
