    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
       ...
       $this->config = array_merge(array(
            'client_table' => 'jm_oauth_clients',//
            'access_token_table' => 'jm_oauth_access_tokens',//
            'refresh_token_table' => 'jm_oauth_refresh_tokens',//
            'code_table' => 'jm_oauth_authorization_codes',//
            'user_table' => 'jm_oauth_users',//
            'jwt_table'  => 'jm_oauth_jwt',//
            'jti_table'  => 'oauth_jti',
            'scope_table'  => 'jm_oauth_scopes',//
            'public_key_table'  => 'jm_oauth_public_keys',
        ), $config);
    }
