        ...
        <div class="main mt20 mainleftbg">
        	...
        	<dd class="leftbar">
                ...
                <ul id="leftlist">
                    ...
                    <li class="cur"><em id="c5"></em><a href="<?php echo U('Project/addstep5?id='.$project_id);?>">融资信息</a></li>
            ...
            <dd class="rightbar">
                ...
                <div class="form">
					<ul>
						<li>
						  <label>项目估值</label>
						  <input type="text" class="c1" id="je" name="fund[project_valuation]" value="<?php echo (round($fund["project_valuation"],2)); ?>" placeholder="请输入金额" datatype="n" nullmsg="请输入金额" errormsg="金额只能是数字">
						</li>
						
						<li>
						  <label>预融资金额</label>
						  <input type="text" class="c1" id="je" name="fund[need_fund]" value="<?php echo (round($fund["need_fund"],2)); ?>" placeholder="请输入金额" datatype="n" nullmsg="请输入金额" errormsg="金额只能是数字">
						</li>
						<li>
						  <label>最低跟投金额</label>
						  <input type="text" class="c1" id="je" name="fund[follow_fund]" value="<?php echo (round($fund["follow_fund"],2)); ?>" placeholder="请输入金额" datatype="n" nullmsg="请输入金额" errormsg="金额只能是数字">
						</li>

						<li>
						  <label>最低领投金额</label>
						  <input type="text" class="c1" id="je" name="fund[lead_fund]" value="<?php echo (round($fund["lead_fund"],2)); ?>" placeholder="请输入金额" datatype="n" nullmsg="请输入金额" errormsg="金额只能是数字">
						</li>
						...
						<li>
						  <label>股东特权</label>
						  <textarea name="fund[extra]" cols="" rows="" value="" class="c2" maxlength="150" placeholder="项目简介不能超过150个字" ><?php echo ($fund["extra"]); ?></textarea>
						</li>
						<li>
						  <label>附加资源</label>
						  <input type="text" class="c1" id="title" name="fund[add_source]" value="<?php echo ($fund["add_source"]); ?>" placeholder="请输入附加资源">
						</li>
						<li>
						  <label>资金用途</label>
						  <textarea name="fund[use_to]" class="c2" placeholder="请输入资金用途"><?php echo ($fund["use_to"]); ?></textarea>
						</li>
						<li class="save">
...
(function(){
	...
	<script src="/Public/Home/js/jQselect.js" type="text/javascript"></script>
