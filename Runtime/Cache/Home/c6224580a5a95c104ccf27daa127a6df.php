        ...
        <div class="main mt20 mainleftbg">
        	...
        	<dd class="leftbar">
                ...
                <ul id="leftlist">
                    ...
                    <li class="cur"><em id="c3"></em><a href="<?php echo U('Project/addstep2?id='.$project_id);?>">项目介绍</a></li>
                ...
                <ul>
                    <li class="xmms">
	                    <div class="ms">
							...
							<!-- 加载编辑器的容器 -->
							<txtarear id="description" name="description"><?php echo ($info["description"]); ?></txtarear>
	                    </div>
                    </li>
                    <li class="xmms"><div class="ms">
                    	<div class="title">研究报告</div>
						<!-- 加载编辑器的容器 -->
					    <txtarear id="plan" name="plan"><?php echo ($info["plan"]); ?></txtarear>
                    </div></li>
                    <li class="xmms"><div class="ms">
                    	<div class="title">目标客户</div>
            			<!-- 加载编辑器的容器 -->
					    <txtarear id="custom" name="custom"><?php echo ($info["custom"]); ?></txtarear>
                    </div></li>
                    <li class="xmms"><div class="ms">
                    	<div class="title">盈利模式</div>
                   		<!-- 加载编辑器的容器 -->
					    <txtarear id="yingli_mode" name="yingli_mode"><?php echo ($info["yingli_mode"]); ?></txtarear>
                    </div></li>
                    <li class="xmms"><div class="ms">
                    	<div class="title">同行竞争</div>
 						<!-- 加载编辑器的容器 -->
					   	<txtarear id="jingzheng" name="jingzheng"><?php echo ($info["jingzheng"]); ?></txtarear>
                    </div></li>
                    <li class="xmms"><div class="ms">
                    	<div class="title">竞争优势</div>
						<!-- 加载编辑器的容器 -->
					    <txtarear id="avantages" name="avantages"><?php echo ($info["avantages"]); ?></txtarear>
                    </div></li>
                    <li class="save">
