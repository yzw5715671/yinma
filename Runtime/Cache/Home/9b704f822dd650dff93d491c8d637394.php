    ...
    <div class="register-form">
        <form method="post" action="<?php echo U();?>" id="register-form">
            <div class="register-form-container">
                <img src="/Public/Home/images/register_ad.png">
                <div class="register-form-container-inner">
                    ...
                    <div class="register-item-container">
                        <input type="text" name="username" class="register-input usericon" placeholder="用户名"
                               ajaxurl="<?php echo U('validateRegister');?>" style="margin-top:27px;" datatype="s3-15"
                    ...
                    <div class="register-item-container">
                        <input type="text" name="mobile" class="register-input usericon4" placeholder="手机号"
                               datatype="n11-11" maxlength="11" nullmsg="请输入手机号码" ajaxurl="<?php echo U('validateRegister');?>"
                               id="phoneNo" errormsg="手机号码必须是11位数字">
                    </div>
                    <?php if(($registerTimes) > "3"): ?><div class="register-item-container">
                           <div>
                                <img class="send-register-code " id="getImgcode" alt="点击切换" src="<?php echo U('verify1');?>">
                           </div>
                    ...
                    <div class="register-item-container">
                        <a title="发送验证码" href="<?php echo U('sendsms');?>" id="cellcode_send"
                    ...
                    <div style="width: 298px; height:36px; line-height:36px; font-size:14px; color:#959595;">
                        ...
                        <span>我同意</span><a href="<?php echo U('Info/show?key=agreement');?>" title="一塔湖图众筹用户服务协议"
...
(function(){
    ...
    <script type="text/javascript" src="/Public/Home/js/jquery.placeholder.min.js"></script>
    <script type="text/javascript">
