...
<script>
 ...
 <div class="pagetag"><a href="<?php echo U('Index/index');?>">首页</a> > <a href="<?php echo U('User/login');?>">登陆</a> > 忘记密码</div>
<div class="findback-psw-container">
  <form method="post" class="form" action="<?php echo U();?>">
    ...
    <div id="errormessage" style="margin-top:-52px;text-align:left"></div>
      ...
      <div class="form-item">
          <img class="send-register-code " style="width:160px;margin-top: 0px;" id="getImgcode" alt="点击切换" src="<?php echo U('verify1');?>">
      ...
      <div class="form-item"> <a href="/Home/User/sendsms/sms_type/forget" id="numclick" title="发送验证码" class="get-rancode getsmscode">发送验证码</a>
