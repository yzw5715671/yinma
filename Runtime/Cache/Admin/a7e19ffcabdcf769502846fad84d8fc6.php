			...
			<div class="pull-left pj-left">
				...
				<div class="under-line">
					<div class="com-info">
						...
						<div class="edit-info">
						<p>
							<?php if(empty($description)): ?>没有内容
							<?php else: ?>
								<?php echo ($description); endif; ?>
						</p>
						</div>
					</div>
					<div class="com-info">
					...
					<div class="com-info">
						...
						<div class="edit-info">
						<p>
							<?php if(empty($custom)): ?>没有内容
							<?php else: ?>
								<?php echo ($custom); endif; ?>
						</p>
						</div>
					</div>
					<div class="com-info">
						...
						<div class="edit-info">
						<p>
							<?php if(empty($yingli_mode)): ?>没有内容
							<?php else: ?>
								<?php echo ($yingli_mode); endif; ?>
						</p>
						</div>
					</div>
					<div class="com-info">
						...
						<div class="edit-info">
						<p>
							<?php if(empty($jingzheng)): ?>没有内容
							<?php else: ?>
								<?php echo ($jingzheng); endif; ?>
						</p>
						</div>
					</div>
					<div class="com-info">
						...
						<div class="edit-info">
						<p>
							<?php if(empty($avantages)): ?>没有内容
							<?php else: ?>
								<?php echo ($avantages); endif; ?>
						</p>
						</div>
					</div>
				</div>
				<div class="under-line">
					<div class="com-info">
						<div class="sub-title">项目大事记
						</div>
						<div id="happen" class="edit-info">
							<table class="tt">
								<thead>
									<tr>
								...
								<tbody>
									<?php if(is_array($projectEvent)): foreach($projectEvent as $key=>$v): ?><tr>
										<td>
											<?php echo (time_format($v["when"],'Y年m月d日')); ?>
										</td>
										<td class="text-left">
											<?php echo ($v["content"]); ?>
										</td>
