...
<div class="xmsteps" style="background:none">
	...
	<div class="under-line form-horizontal">
		<div class="com-info" style="margin-bottom:10px">
			<div class="sub-title">融资需求</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">项目估值</label>
			<div class="controls value-money">
				<?php echo (number_format($project_valuation)); ?>
			</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">预融资金额</label>
			<div class="controls value-money">
				<?php echo (number_format($need_fund)); ?>
			</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">最低跟投金额</label>
			<div class="controls value-money">
				<?php echo (number_format($follow_fund)); ?>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">到账方式</label>
			<div class="controls">
				<?php echo (get_code_name($to_way)); ?>
			</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">附加资源</label>
			<div class="controls">
				<?php if(empty($add_source)): ?>没有数据
				<?php else: ?>
					<?php echo ($add_source); endif; ?>
			</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">股东特权</label>
			<div class="controls">
				<?php if(empty($add_source)): ?>没有数据
				<?php else: ?>
					<?php echo ($extra); endif; ?>
			</div>
		</div>
	...
	<div class="under-line form-horizontal">
		<div class="com-info" style="margin-bottom:10px">
			<div class="sub-title">资金用途</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">资金用途</label>
			<div class="controls">
				<?php if(empty($use_to)): ?>没有数据
				<?php else: ?>
					<?php echo ($use_to); endif; ?>
			</div>
		</div>
	</div>
	<?php
...
<script src="/Public/Admin/js/project/preview.js"></script>
<script>
