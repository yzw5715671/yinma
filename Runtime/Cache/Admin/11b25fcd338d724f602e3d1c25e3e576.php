...
<div class="xmsteps" style="background:none">
	...
	<div class="under-line">
		<div class="com-info">
			<div class="sub-title">宣传图片</div>
			<div class="edit-info">
			<?php if(is_array($projectTemp)): foreach($projectTemp as $key=>$v): if($v["temp_type"] == 1): ?><a class="ui-colorbox-group ui-img-modal" href="<?php echo (get_cover($v["info_key"],'path')); ?>"><img src="<?php echo (get_cover($v["info_key"],'path')); ?>" alt="" style="width:200px"></a><?php endif; endforeach; endif; ?>
			</div>
		</div>
	</div>
	<div class="under-line">
		<div class="com-info">
			<div class="sub-title">相关视频</div>
			<div class="edit-info">
			<?php if(is_array($projectTemp)): foreach($projectTemp as $key=>$v): if($v["temp_type"] == 0): ?><embed src="<?php echo ($v["info_key"]); ?>" allowFullScreen="true" quality="high" width="480" height="400" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
...
<script>
	$(document).ready(function(){
		$(".ui-colorbox-group").colorbox({rel:'ui-colorbox-group', width:'70%', height:'80%'});
	});
