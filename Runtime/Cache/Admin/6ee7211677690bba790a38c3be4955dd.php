...
<div class="xmsteps" style="background:none">
	...
	<div class="under-line">
			<div class="com-info">
				<div class="sub-title">股东团队成员说明 </div>
				<div class="edit-info">
				<table class="tt">
					<thead>
					...
					<tbody id="member_key">
						<?php if(is_array($projectTeam)): foreach($projectTeam as $key=>$v): if(($v["member_type"]) == "0"): ?><tr>
		...
		<div>
<!-- 			<button href="<?php echo U('Project/addstep2?id=' . $project_id);?>" class="btn-yellow btn-middle pull-left" id="goback1">上一步</button>
			<button type="submit" class="btn-red btn-middle pull-right">下一步</button> -->
		</div>
<?php
